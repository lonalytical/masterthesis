...
However, relatively little research has investigated how these two challenges interact. In particular, it remains unclear how small-sample inference procedures perform when model parameters are estimated in the presence of missing data and handled using modern missing-data methods.
