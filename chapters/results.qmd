...
Standard deviations of point estimates across conditions and methods are illustrated in @fig-sd for MAR, as differences between missingness mechanisms were small.
...
```{r echo=FALSE, message=FALSE}
#| label: fig-ciw
#| fig.cap: "Width of confidence/credible intervals for $\\gamma_{01} = 0.40$ under missing at random (MAR) and $ICC = .10$, where ICC denotes the intraclass correlation coefficient used for both the residual ICC of $Y$ and the ICC of $X$. Error bars represent ±2 Monte Carlo standard errors (MCSE). $N_2$ = number of groups; MI-Rubin = multiple imputation with Rubin's degrees of freedom; MI-adjusted = multiple imputation with small-sample-adjusted degrees of freedom."
#| fig.scap: "Width of confidence/credible intervals for $\\gamma_{01}=0.40$"
#| fig-asp: 0.45
#| out-width: 100%
